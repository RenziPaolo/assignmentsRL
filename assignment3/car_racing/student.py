...
class Policy(nn.Module):
    ...
    def __init__(self, device=torch.device('cpu')):
        ...
        self.device = device
        #TODO 
        self.VAE = VAE(in_channels = 96*96*3, latent_dim = 100, hidden_dims = None)
        self.MDN_RNN = MDN_RNN(input_size = 100+3+10, hidden_size = 5)
        self.C = nn.linear()
